...
# and https://github.com/GistNoesis/FourierKAN
import math
...
class KANLayer(nn.Module):
    def __init__(self, input_features, output_features, grid_size=5, spline_order=2, base_activation=nn.GELU,
                 grid_range=[-1, 1]):
...
class ChebyKANLayer(nn.Module):
    def __init__(self, input_dim, output_dim, degree=10):
...
class GRAMLayer(nn.Module):
    def __init__(self, in_channels, out_channels, degree=2, act=nn.SiLU):
